...
<header class="bg-gray-700 sticky top-0 z-50" x-data="dropdown()"> {{-- agregamos x-data pq le decimos a alpine que agrega funcionalidad a esta etiqueta --}}
    ...
    <nav x-show="open" id="navigation-menu" 
        ...
        <div class="container h-full hidden md:block">
            <div
                ...
                <ul class="bg-white">
                    @foreach ($categories as $c)
                        <li class="navigation-link text-gray-500 hover:bg-orange-500 hover:text-white">                            
                            <a href=" {{route('categories.show', $c)}} " class="py-2 px-4 text-sm flex items-center">
                            ...
                            <div class="navigation-submenu bg-gray-100 absolute w-3/4 top-0 right-0 h-full hidden">
                                <x-navigation-subcategories :category="$c" />
                            </div>
                        </li>
                    @endforeach
                </ul>
                ...
                <div class="col-span-3 bg-gray-100">
                    {{-- {{$categories->first()}} --}}
                    <x-navigation-subcategories :category="$categories->first()" /> {{-- dos puntos para pasarle una variable php --}}
                </div>
            </div>
        </div>
        ...
        <div class="bg-white h-full overflow-y-auto">
            ...
            @auth
                ...
                <a href="" onclick="event.preventDefault(); document.getElementById('logout-form').submit()" class="py-2 px-4 text-sm flex items-center text-gray-500 hover:bg-orange-500 hover:text-white">
                    <span class="flex justify-center w-9">
